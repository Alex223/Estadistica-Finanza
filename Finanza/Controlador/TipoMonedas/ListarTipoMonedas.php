<?php
                     ...
                     echo("   <table class='table table-striped'> 
                      ...
                      <tr>
                          <td align='center' ><b> ID</b> </td><td align='center'><b> Nombre Tipo Moneda </b></td><td><td>
                        ...
                        if (mysql_num_rows($resultado1) == 0) {
                           ...
                           echo("<tr id='filaIngreso'>
                                         <td><button class='btn btn-sm btn-default btn-block' type='button'onclick=".'"'."IngresarFilaTipoMoneda();".'""'." ><span class='glyphicon glyphicon-plus-sign'> Agregar </span></button></td><td colspan='3'></td>
                                    </tr>");
